...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.CameraRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.CarStateTimer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.CarDetectedNotify", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.ExpiredListCarNotify", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.InspectionRequiredCarNotify", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.NotInListCarNotify", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.UnknownCarNotify", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.WaitingList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CarWaitingList", b =>
                {
                    b.HasOne("Warehouse.DataBase.Models.Main.Car", null)
                        .WithMany()
                    ...
                    b.HasOne("Warehouse.DataBase.Models.Main.WaitingList", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.CarDetectedNotify", b =>
                {
                    b.HasOne("Warehouse.DataBase.Models.Main.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
            ...
            modelBuilder.Entity("Warehouse.DataBase.Models.Main.Notifies.ExpiredListCarNotify", b =>
                {
                    ...
                    b.HasOne("Warehouse.DataBase.Models.Main.CameraRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .HasConstraintName("fk_expired_list_car_notifies_camera_roles_role_id");

                    b.HasOne("Warehouse.DataBase.Models.Main.WaitingList", "WaitingList")
                        .WithMany()
